...
* Name: Lydia Kim
* Date: May 16, 2023
* Title: Lab6 - UDP Server
* Description: This program should act as a UDP server with packets that have checksum, sequence number, acknowledgement number and timer
*/
...
Packet serverReceive(int sockfd, struct sockaddr *address, socklen_t *addrlen, int seqnum) {
	...
	while (1) {
		...
		} else { //if the ckechsum and sequence numbers are correct send ack with the right sequence number
